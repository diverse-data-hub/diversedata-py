...
def load_wildfire():
    """
    Returns the Alberta Historical Wildfire Dataset (2006-2024) as a pandas.DataFrame.
    ...
    true_cause : Detailed fire cause (e.g., "Arson Known", "Hot Exhaust", "Line Impact", "Unattended Fire", etc.).
    fire_start_date : Date the fire started.
    detection_agent_type : Type of detection method used (e.g., lookout ("LKT"), aircraft ("AIR")).
    ...
    fire_type : Fire behavior classification (e.g., "Surface", "Ground", "Crown").
    fire_position_on_slope : Position of the fire on slope (e.g., "Bottom", "Middle 1/3", "Unknown").
    weather_conditions_over_fire : Description of weather at the fire location.
