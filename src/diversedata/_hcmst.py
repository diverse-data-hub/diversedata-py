...
def load_hcmst():
    """
    Returns the How Couples Meet and Stay Together (HCMST) – 2022 Wave data as a pandas.DataFrame.
    ...
    subject_education : Highest degree obtained (e.g. "no_education", "11th", "masters_degree")
    ...
    rel_change_during_pandemic : Relationship change during the COVID-19 pandemic.
    ...
    Notes
    -----
    Distributed under a data use agreement. Do not use this dataset to identify individuals.
    Please cite appropriately in publications and reports.
