...
def load_genderassessment():
    """
    Returns the Gender Assessment 2024 Dataset as a pandas.DataFrame.
    ...
    development_recruitment : Recruitment and career development opportunities by gender.
    employee_data_by_sex : Availability of employee data by sex.
    supply_chain_gender_leadership : Gender representation in supply chain leadership.
    enabling_environment_union_rights : Union rights and enabling environment for gender equity.
    ...
    Notes
    -----
    Data sourced from World Benchmarking Alliance is available under the Creative Commons
    ...
    >>> df = dd.load_genderassessment()
    >>> df.head()
        company   country         region          ...
    0  3M        United States   North America   ...
    """
    return load_data("genderassessment")