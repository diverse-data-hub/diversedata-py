...
def load_bcindigenousbiz():
   """
   Returns the BC Indigenous Business Directory (1910-2021) as a pandas.DataFrame.
   ...
   type : Type or structure of the business (e.g., "sole proprietorship", "corporation").
   industry_sector : Primary industry sector of the business.
   year_formed : Year the business was officially formed (ranging from 1910 to 2021).
   number_of_employees : Approximate number of employees.

   Source
   ------
   Government of British Columbia via the Government of Canada's Open Government Portal:
